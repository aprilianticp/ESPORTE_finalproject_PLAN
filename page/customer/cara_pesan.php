      ...
      <div class="container-fluid">
        ...
        <div class="nav navbar-nav navbar-right">
         <ul id="nav">
          ...
          <li class="a"><a href="keranjang.php" style="background:#FFFFF3;color:#072957;"><span class="glyphicon glyphicon-shopping-cart"> Keranjang[<?php
          include"../../conn.php";
...
<li><?php include("kat.php");?></li>
  ...
  <div class="container-fluid">
    ...
    <div style="margin-top:-30px;width:100%,height:60px;text-align:center;background:#072957;color:#fff;line-height:50px;font-size:20px;margin-bottom:30px;">
Cara Pesan
</div>
<center>
<div style="margin-top:-30px;width:100%,height:500px;background:#fff;color:#072957;line-height:50px;font-size:20px;margin-bottom:30px;">
  <div class="row" style="margin: 10px;">
    <table>
      <tr>
        <td><strong>1.</strong></td>
        <td>Pembayaran dilakukan dalam jangka waktu 1x24 jam setelah melakukan pemesanan.</td>
      </tr>
      <tr>
        <td><strong>2.</strong></td>
        <td>Pembayaran dapat dilakukan melalui transfer ke Rekening kami.</td>
      </tr>
      <tr>
        <td></td>
        <td>Melalui Konfirmasi Pembayaran</td>
      </tr>
      <tr>
        <td><strong>3.</strong></td>
        <td>Setelah melakukan pembayaran, konfirmasi pembayaran dikirim ke-</td>
      </tr>
      <tr>
        <td></td>
        <td style="color: #0000ff;"><strong>Aprilia Putri, MANDIRI KOPO, BANDUNG, No. Rek: 123.456.789.0</strong></td>
      </tr>
      <tr>
        <td><strong>4.</strong></td>
        <td>Selanjutnya olahraga yang telah dipesan akan dikirimkan dalam waktu maksimal 7 Hari.</td>
      </tr>
      <tr>
        <td><strong>5.</strong></td>
        <td>Kami mengirimkan barang dengan menggunakan jasa pengiriman barang via POST</td>
      </tr>
      <tr>
        <td></td>
        <td style="color: red;"><em>* Harga barang belum termasuk ongkos kirim, dan ongkos kirim akan disesuaikan dengan tujuan pengiriman.</em></td>
      </tr>
    </table>
  </div>
</div>
