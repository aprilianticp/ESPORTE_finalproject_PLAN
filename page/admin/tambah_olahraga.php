...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($conn,"INSERT into olahraga set series='$series',id_ketegori='$id_kategori',warna='$warna',merk='$merk',ukuran='$ukuran',harga='$harga', gambar='$nama_file_baru', stok='$stok'");
